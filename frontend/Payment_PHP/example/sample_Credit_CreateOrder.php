...
*/
    ...
    $query=$db->query("SELECT * FROM order_details WHERE customer_orderID=".$_POST['customer_orderID']);
    ...
    try {
        ...
        $obj->SendExtend['OrderResultURL'] = 'http://www.happy_cake.com/happy_cake/frontend/payment_success.php' ;
