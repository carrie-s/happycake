       ...
       <div class="container">
           ...
           <div class="col-md-6" data-animate="fadeInDown">
               ...
               <?php if(isset($_SESSION['member']) && $_SESSION['member'] !=null) { ?>
                    <li style="color:white;"><?php echo $_SESSION['member']['name']; ?>您好　<a href="customer-account.php" >會員專區</a>
                   </li>
                    <li>
                           ...
                           <li>
                               <div class="yamm-content">
                                   <div class="row">
                                    ...
                                    <a href="product_list.php?categoryID=<?php echo $class['product_categoryID']; ?>&category=<?php echo $class["category"]; ?>">
