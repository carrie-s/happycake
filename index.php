        ...
        <div class="container">
            ...
            <div class="col-md-6" data-animate="fadeInDown">
                ...
                <?php if(isset($_SESSION['member']) && $_SESSION['member'] !=null) { ?>
                    <li style="color:white;"><?php echo $_SESSION['member']['name']; ?>您好　<a href="frontend/customer-account.php" >會員專區</a>
                   </li>
                    <li>
                           ...
                           <li>
                               <div class="yamm-content">
                                   <div class="row">
                                    ...
                                    <a href="frontend/product_list.php?categoryID=<?php echo $class['product_categoryID']; ?>&category=<?php echo $class["category"]; ?>">
                                    <h5><?php echo $class['category']; ?></h5></a>
                                    <?php } ?>    
                                       </div>                                       
                                   </div>
                               </div>
            ...
            <div class="box text-center" data-animate="fadeInUp">
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <p class="lead">想了解更多消息嗎? <a href="frontend/news_list.php">馬上到最新消息!</a>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <?php foreach($news as $data){ ?>
                        <div class="col-sm-6">
                            <div class="post">
                                ...
                                <hr>
                                <p class="intro"><?php echo mb_strimwidth(strip_tags($data["content"]), 0 , 150, "...") ; ?></p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <a href="frontend/product_list.php?categoryID=<?php echo $footer_categories['product_categoryID']; ?>&category=<?php echo $footer_categories["category"]; ?>">
